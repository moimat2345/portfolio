...
function StackIcon({ name }: { name: string }) {
  return (
    <MagneticIcon>
      <motion.div
        className="flex items-center gap-2 px-5 py-3 glass rounded-xl whitespace-nowrap group cursor-default transition-all duration-300 hover:border-violet/40 hover:bg-white/[0.08]"
        whileHover={{
